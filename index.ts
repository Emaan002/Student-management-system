  ...
  if (viewAndExit.information === "View") {
    console.log(
      chalk.bold.whiteBright(
        `\tCongratulation, ${answer.students} you have purchased this course.\n`
      )
    );
    console.log(chalk.bold.blue(" Your Status"));
    console.log(
      chalk.green(`Student Name: ${chalk.bold.underline(answer.students)}`)
    );
    console.log(
    ...
    console.log(
      chalk.green(
        `Balance ${chalk.bold.underline(studentBalance + paymentAmount)}`
      )
    );
  } else {
